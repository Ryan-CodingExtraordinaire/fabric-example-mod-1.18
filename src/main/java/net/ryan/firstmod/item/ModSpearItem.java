...
public class ModSpearItem extends Item {
    ...
    public ModSpearItem(ToolMaterial toolMaterial, int itemAttackDamage, float attackSpeed, Settings settings) {
        super(settings);
        this.attackDamage = itemAttackDamage + toolMaterial.getAttackDamage();
