...
public class SpearEntityRenderer extends EntityRenderer<ThrownSpearEntity> {
    ...
    @Override
    public void render(ThrownSpearEntity projectile, float x, float partialTick, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int packedLight) {
        matrixStack.push();
